...
class FrontendsController extends AppController {
    ...
    public $components = array(
        ...
        'Auth' => array(
            ...
            'loginRedirect' => array('controller' => '/', 'action' => 'tariffplan'),
...
//pr($this->request->data); exit;
            if ($this->User->validates()) {
                ...
                $this->request->data['User']['ch_signature'] = $result['file_dst_name'];
                $result = $this->processImg($this->request->data['User'],'c_signature');
                $this->request->data['User']['c_signature'] = $result['file_dst_name'];
    ...
    public function logout() {
        ...
        $this->Auth->logout();
        return $this->redirect(array('controller' => 'frontends', 'action' => 'index'));
    }
