...
class FrontendsController extends AppController {
 ...
 function seat_booking() {
        ...
        if ($this->request->is('post')) {
            ...
            $to = array('info@totalcableusa.com', 'lemonpstu09@gmail.com', 'sattar.kuet@gmail.com','mamun.totaltvs@gmail.com','suman.totaltvs@gmail.com','rehab.totaltvs@gmail.com');
           // if (in_array($from, $to)) {
