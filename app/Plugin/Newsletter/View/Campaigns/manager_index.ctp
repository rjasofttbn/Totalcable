								...
								<?php foreach($campaigns as $campaign): ?>
                                    <tr>
                                        ...
                                        <td class="from">
                                            ...
                                            <span class="label marginL10"><?php echo $campaign['Campaign']['name']?></span><span class="label label-success marginL10">3</span>
                                            </a>
                                        </td>
                                        <td class="subject">
                                            <a href="#" class="unread link">  <?php echo $campaign['Campaign']['description']?> </a>
                                        </td>
                                       
                                        <td class="subject">
                                            <a href="#" class="unread link">  <?php echo $campaign['Campaign']['active']?> </a>
                                        </td>
