        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="box">
                    ...
                    <div class="content">
                        <?php
                        echo $this->Form->create('TariffCountry', array(
                            'inputDefaults' => array(
                                'label' => false,
                                'div' => false
                            ),
                        ...
                        <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="checkboxes">Existing State name</label>
                                        <div class="span9 controls sel">
                                            <?php
                                            echo $this->Form->input('id', array(
                                                'type' => 'select',
                                                'id' => 'select1',
                                                'options' => $TariffCountries,
                                                'empty' => 'select package name',
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    <label class="form-label span3" for="required">New State Name</label>
                                    <?php
