            ...
            <div class="span12">
                ...
                <div class="box">
                    ...
                    <div class="title">
                        ...
                        <h4>
                            <span>Edit & Update Country Name</span>
                        </h4>
                    ...
                    <div class="content">
                        ...
                        <div class="form-row row-fluid">
                                <div class="span12">
                                    <div class="row-fluid">
                                        <label class="form-label span3" for="checkboxes">Existing Country name</label>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    <label class="form-label span3" for="required">New Country Name</label>
                                    <?php
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="span9 controls">
                                            ...
                                            echo $this->Form->button(
                                                    'Update', array('class' => 'btn btn-success', 'type' => 'submit')
                                            );
                                            ?>
