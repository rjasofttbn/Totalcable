...
<div class="alert alert-success">
        ...
        <strong>  There are <?php echo $seats; ?> seats already 
                        <?php echo $this->Session->flash(); ?> </strong>
    </div>
                    ...
                    <div class="content">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    <label class="form-label span3" for="required">How many new seat</label>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="span9 controls">
                                            ...
                                            echo $this->Form->button(
                                                    'Create', array('class' => 'btn btn-success', 'type' => 'submit')
                                            );
                                            ?>
