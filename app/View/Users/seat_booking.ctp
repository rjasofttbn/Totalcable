                    ...
                    <div id="showprview" class="localcss" align="center" style="width: 100%; margin-left: auto; margin-right: auto; position: relative;">
                        ...
                        <div class="seperate st-sec">
                            ...
                            <div class="seatplan_row">
                                <div class="l" style="list-style:none;">
                                        ...
                                        for ($row = 0; $row < 5; $row++):
                                            ...
                                            <div class="quater-half">
                                                ...
                                                foreach ($reverse as $seat):
                                                    ?>
                                                    <div class="admin-<?php echo status($status, $seatNo); ?> showseats" name="<?php echo $level[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                    </div>
                                    ...
                                    <div class="quater">
                                        <div class="quater-half">
                                            <div name="UU101" class="admin-<?php echo status($status, $seatNo); ?> showseats" id="<?php
                                            echo $seatNo++;
                                            ?>" title="This seat is <?php echo status($status, $seatNo); ?>">101
                                            </div>

                                            <div name="UU102" class="admin-<?php echo status($status, $seatNo); ?> showseats" id="<?php
                                            echo $seatNo++;
                                            ?>" title="This seat is <?php echo status($status, $seatNo); ?>">102
                                            </div>
                                            <div class="showseats noborder" > </div>
                                            <div name="UU116" class="admin-<?php echo status($status, $seatNo); ?> showseats" id="<?php
                                            echo $seatNo++;
                                            ?>" title="This seat is <?php echo status($status, $seatNo); ?>">116
                                            </div>
                                        </div>
                                        <div class="quater-half">
                                            <div name="TT101"class="admin-<?php echo status($status, $seatNo); ?> showseats" id="<?php
                                            echo $seatNo++;
                                            ?>" title="This seat is <?php echo status($status, $seatNo); ?>">101
                                            </div>
                                            <div class="showseats noborder"></div>
                                            <div name="TT115" class="admin-<?php echo status($status, $seatNo); ?> showseats" id="<?php
                                            echo $seatNo++;
                                            ?>" title="This seat is <?php echo status($status, $seatNo); ?>">115
                                            </div>
                                            <div name="TT116" class="admin-<?php echo status($status, $seatNo); ?> showseats" id="<?php
                                            echo $seatNo++;
                                            ?>" title="This seat is <?php echo status($status, $seatNo); ?>">116
                                            </div>
                                        ...
                                        for ($row = 0; $row < 3; $row++):
                                            ...
                                            <div class="quater-half">
                                                ...
                                                foreach ($seats101 as $seat):
                                                    ?>
                                                    <div name="<?php echo $level[$row + 2] . $seat; ?>" class="admin-<?php echo status($status, $seatNo); ?> showseats showseats101 "  id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                    </div>
                                                    <?php
                                                endforeach;
                                                ?>
                                        ...
                                        <div class="quater">
                                            ...
                                            for ($row = 0; $row < 5; $row++):
                                                ...
                                                <div class="quater-half">
                                                    ...
                                                    foreach ($odd as $seat):
                                                        ?>
                                                        <div name="<?php echo $level[$row] . $seat; ?>"  class="admin-<?php echo status($status, $seatNo); ?> showseats" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                        </div>
                            ...
                            <div class="seatplan_row">
                                <div class="l" style="list-style:none;float: left;">
                                            ...
                                            if ($row == 2 || $row == 3) {
                                                ...
                                                <div class="quater-half">
                                                    ...
                                                    foreach ($reverse as $seat):
                                                        ...
                                                        ?>
                                                        <div class="admin-<?php echo status($status, $seatNo); ?>  showseats row_color "  name="<?php echo $level[$row + 5] . $seat; ?>"  id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                        </div>
                                            ...
                                            <?php }else { ?>
                                                <div class="quater-half">
                                                    ...
                                                    foreach ($reverse as $seat):
                                                        //foreach (range(0, 12) as $seat) :
                                                        ?>
                                                        <div class="admin-<?php echo status($status, $seatNo); ?> showseats" name="<?php echo $level[$row + 5] . $seat; ?>" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                        </div>
                                    ...
                                    <div class="quater">
                                        <div class="quater-half">
                                            <div class="admin-<?php echo status($status, $seatNo); ?> noborder-left" title="This seat is <?php echo status($status, $seatNo); ?>">
                                                ...
                                                <div class="quater-half">
                                                    ...
                                                    <div class="text-sec">
                                                        <div class="text-secpart">
                                                            ...
                                                            foreach ($seats101 as $seat):
                                                                ?>
                                                                <div class="admin-<?php echo status($status, $seatNo); ?> showseats showseats101  row_color" name="<?php echo $level[$row + 5] . $seat; ?>" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                                </div>
                                                                <?php
                                                            endforeach;
                                                            ?>
                                                ...
                                                <div class="quater-half">
                                                    ...
                                                    <div class="text-sec">
                                                        <div class="text-secpart">
                                                            ...
                                                            foreach ($seats101 as $seat):
                                                                ?>
                                                                <div class="admin-<?php echo status($status, $seatNo); ?> showseats showseats101  "  name="<?php echo $level[$row + 5] . $seat; ?>" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                                </div>
                                                                <?php
                                                            endforeach;
                                                            ?>
                        ...
                        <div class="seperate">
                            ...
                            <div class="seatplan_row" >
                                <div class="l" style="list-style:none;">
                                    <div class="quater">
                                        ...
                                        for ($row = 0; $row < 5; $row++):
                                            ...
                                            <div class="quater-half">
                                                ...
                                                foreach ($reverse as $seat):
                                                    ?>
                                                    <div class="admin-<?php echo status($status, $seatNo); ?> showseats"   name="<?php echo $levels[$row] . $seat; ?>"  id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                    </div>
                                    ...
                                    <div class="quater">
                                        ...
                                        <div class="admin-<?php echo status($status, $seatNo); ?> showseats" name="<?php echo $levels[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>" >18
                                        </div>
                            ...
                            <div class="r">
                                ...
                                <div class="quater">
                                    ...
                                    <div class="admin-<?php echo status($status, $seatNo); ?> showseats rightone"  name="<?php echo $levels[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>">18
                                    </div>
                                    ...
                                    <div class="quater">
                                        ...
                                        for ($row = 0; $row < 12; $row++):
                                            ...
                                            <div class="quater-half">
                                                ...
                                                foreach ($reverse as $seat):
                                                    ?>
                                                    <div class="admin-<?php echo status($status, $seatNo); ?> showseats" name="<?php echo $levels_mid[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                    </div>
                                    ...
                                    <div class="quater">
                                        ...
                                        for ($row = 0; $row < 12; $row++):
                                            ...
                                            ?>
                                                ...
                                                <div class="quater-half" value="<?php echo $row; ?>">
                                                    <!-- <li class="ltr">A</li> -->
                                                        ...
                                                        <div class="admin-<?php echo status($status, $seatNo); ?> showseats"  name="<?php echo $levels_mid[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>" style="border: 2px solid black;width: 74px;font-size: 10px;" title="This seat is <?php echo status($status, $seatNo); ?>">
                                                             1 WC SPACE
                                                        </div>
                                            ...
                                            elseif ($row == 11) {
                                                ...
                                                <div class="quater-half" value="<?php echo $row; ?>">
                                                    <!-- <li class="ltr">A</li> -->
                                                        ...
                                                        <div class="admin-<?php echo status($status, $seatNo); ?> showseats" name="<?php echo $levels_mid[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>" style="border: 2px solid black;width: 146px;font-size: 12px;" title="This seat is <?php echo status($status, $seatNo); ?>">
                                                            Audio Bay
                                                        </div>
                                            ...
                                            <div class="quater-half">
                                                ...
                                                foreach ($seats118 as $seat):
                                                    ?>
                                                    <div class="admin-<?php echo status($status, $seatNo); ?> showseats showseats101" name="<?php echo $levels_mid[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                            <?php
                                    ...
                                    <div class="r" style="list-style:none;">
                                        <div class="quater">
                                            ...
                                            for ($row = 0; $row < 12; $row++):
                                                if ($row == 0) {
                                                ?>
                                                    <div class="admin-<?php echo status($status, $seatNo); ?> showseats" name="<?php echo $levels_mid[$row]; ?>1" id="1" style="border: 2px solid black;width: 61px;height: 46px;font-size: 10px;position: absolute;right: 192px;/* z-index: 1; */"title="This seat is <?php echo status($status, $seatNo); ?>">
                                                        1 WC SPACE
                                                    </div>
                                                ...
                                                <div class="quater-half" value="<?php echo $row; ?>">
                                                    <!-- <li class="ltr">A</li> -->
                                                        ...
                                                        <div class="booked showseats"style="border: none;width: 11%;" title="Seat A1 Booked"><?php //echo $seat; ?>
                                                            ...
                                                            <div class="admin-<?php echo status($status, $seatNo); ?> showseats" name="<?php echo $levels_bottom[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>" title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                            </div>
                                                            <?php 
                                                        }
                                                ...
                                                <div class="quater-half" value="<?php echo $row; ?>">
                                                    ...
                                                    foreach ($reverse as $seat):
                                                        if ($seat == 20) {
                                                            //foreach (range(0, 12) as $seat) :
                                                            ?>
                                                            <div class="admin-<?php echo status($status, $seatNo); ?> showseats"   name="<?php echo $levels_bottom[$row] . $seat; ?>" style="border: none;width: 11%;" title="This seat is <?php echo status($status, $seatNo); ?>"><?php //echo $seat;      ?>
                                                            </div>
                                        ...
                                        for ($row = 0; $row < 16; $row++):
                                            ...
                                            if ($row == 11 || $row == 10 || $row == 9) {
                                                ...
                                                <div class="quater-half">
                                                    ...
                                                    foreach ($seats118 as $seat):
                                                        ?>
                                                        <div class="admin-<?php echo status($status, $seatNo); ?> showseats showseats101" name="<?php echo $levels_bottom[$row] . $seat; ?>" id="<?php echo $seatNo++; ?>"  title="This seat is <?php echo status($status, $seatNo); ?>"><?php echo $seat; ?>
                                                        </div>
                                                    <?php endforeach; ?>
                                                </div>
                                            ...
                                            <?php }else { ?>
                                                ...
                                                <div class="quater-half">
                                                    ...
                                                    foreach ($seats118 as $seat):
                                                        ?>
                                                        <div class="admin-<?php echo status($status, $seatNo); ?> showseats showseats101" name="<?php echo $levels_bottom[$row] . $seat; ?>" title="This seat is <?php echo status($status, $seatNo); ?>" id="<?php echo $seatNo++; ?>"><?php echo $seat; ?>
                                                        </div>
                                                    <?php endforeach; ?>
                                                </div>
                                            <?php } ?>
                                                ...
                                                elseif ($row == 12) {
                                                    ...
                                                    <div class="quater-half" value="<?php echo $row; ?>" >
                                                        ...
                                                        foreach ($odd20 as $seat):
                                                            //foreach (range(0, 12) as $seat) :
                                                            ?>
                                                            <div class="admin-<?php echo status($status, $seatNo); ?> showseats" name="<?php echo $levels_bottom[$row] . $seat; ?>" title="This seat is <?php echo status($status, $seatNo); ?>" id="<?php echo $seatNo++; ?>" ><?php echo $seat; ?>
                                                            </div>
                        ...
                        <div class="cart">
                            <div class="cartitems">
                                ...
                                <button type="button" id="bookbtn" class="btn btn-info btn-lg buttonglowing" data-toggle="modal" data-target="#bookForm">Make Available</button>
                                                ...
                                                <div class="col-md-7 col-sm-7">  
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        echo $this->Form->button(
                                                                'Confirm', array('class' => 'btn marginR10', 'type' => 'submit')
                                                        );
                                                        ?>
