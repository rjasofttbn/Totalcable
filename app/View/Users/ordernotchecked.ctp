    ...
    <div class="contentwrapper"><!--Content wrapper-->
        ...
        <div class="heading">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Order not checked</li>
            </ul>
                    ...
                    <div class="content noPad clearfix">
                        <table cellpadding="0" cellspacing="0" border="0" class="responsive dynamicTable display table table-bordered" width="100%">
                            ...
                            <tbody>
                                ...
                                <?php
                                foreach ($ordernotchecks as $single):
                                    $put = $single['Reseller'];
                                    ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <div class="controls center">
                                          ...
                                          href="<?php echo Router::url(array('controller'=>'users','action'=>'cancelorder',$put['id'])
                                           ...
                                           <a aria-describedby="qtip-7" data-hasqtip="true" title="" oldtitle="Edit task"
                                          onclick="if (confirm(&quot;Are you sure to active this order?&quot;)) { return true; } return false;"

                                          href="<?php echo Router::url(array('controller'=>'users','action'=>'activeorder',$put['id'])
                                          )?>" class="tip"><span class="icon12 icomoon-icon-checkmark" title="active order"></span></a>
